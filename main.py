...
class Application(object):
    def __init__(self,master):
        ...
        self.personBtn=Button(self.bottom,text='    My Poeple   ',font='arial 12 bold',command=self.openMyPeople)
        ...
        self.addpersonBtn = Button(self.bottom, text='  Add Poeple   ', font='arial 12 bold',command=self.funcAddPeople)
